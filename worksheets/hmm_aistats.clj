...
;;; # AISTATS Examples
;;; 
;;; This is the HMM benchmark from the 2014 AISTATS paper.
;; **
...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"b46717e3-f657-4e0a-8180-463414122b75","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"b46717e3-f657-4e0a-8180-463414122b75","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"b46717e3-f657-4e0a-8180-463414122b75"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"#05A"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"b46717e3-f657-4e0a-8180-463414122b75","values":[{"x":1.0,"y":0.598953844063072},{"x":1.301029995663981,"y":0.5903394417292359},{"x":1.6989700043360185,"y":-0.08153485739551383},{"x":2.0,"y":-0.15972110703824355},{"x":2.301029995663981,"y":-0.44199814273800003},{"x":2.6989700043360183,"y":-0.9093027063681236},{"x":2.9999999999999996,"y":-1.1195049928886145},{"x":3.301029995663981,"y":-1.3734085434661052},{"x":3.6989700043360187,"y":-2.0116932534465173},{"x":4.0,"y":-2.3922830327414633}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"b46717e3-f657-4e0a-8180-463414122b75\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"b46717e3-f657-4e0a-8180-463414122b75\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"b46717e3-f657-4e0a-8180-463414122b75\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"#05A\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"b46717e3-f657-4e0a-8180-463414122b75\", :values ({:x 1.0, :y 0.598953844063072} {:x 1.301029995663981, :y 0.5903394417292359} {:x 1.6989700043360185, :y -0.08153485739551383} {:x 2.0, :y -0.15972110703824355} {:x 2.301029995663981, :y -0.44199814273800003} {:x 2.6989700043360183, :y -0.9093027063681236} {:x 2.9999999999999996, :y -1.1195049928886145} {:x 3.301029995663981, :y -1.3734085434661052} {:x 3.6989700043360187, :y -2.0116932534465173} {:x 4.0, :y -2.3922830327414633})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
