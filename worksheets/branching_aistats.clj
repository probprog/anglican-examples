...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"3f5994e0-e25f-43f8-900c-1c0902485127","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"3f5994e0-e25f-43f8-900c-1c0902485127","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"3f5994e0-e25f-43f8-900c-1c0902485127"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"#05A"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"3f5994e0-e25f-43f8-900c-1c0902485127","values":[{"x":4.0,"y":-3.0963782090414576},{"x":4.30102999566398,"y":-3.229524557785127},{"x":4.698970004336019,"y":-3.3460551633244195},{"x":5.0,"y":-3.6880157283197614},{"x":5.301029995663981,"y":-3.6324460097398785},{"x":5.698970004336018,"y":-3.8029404788139978},{"x":5.999999999999999,"y":-3.836422850373909}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"3f5994e0-e25f-43f8-900c-1c0902485127\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"3f5994e0-e25f-43f8-900c-1c0902485127\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"3f5994e0-e25f-43f8-900c-1c0902485127\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"#05A\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"3f5994e0-e25f-43f8-900c-1c0902485127\", :values ({:x 4.0, :y -3.0963782090414576} {:x 4.30102999566398, :y -3.229524557785127} {:x 4.698970004336019, :y -3.3460551633244195} {:x 5.0, :y -3.6880157283197614} {:x 5.301029995663981, :y -3.6324460097398785} {:x 5.698970004336018, :y -3.8029404788139978} {:x 5.999999999999999, :y -3.836422850373909})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
