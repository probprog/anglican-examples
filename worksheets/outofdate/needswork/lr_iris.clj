...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"335d6dcc-829f-4e75-86f2-fa62af52b3bf","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"335d6dcc-829f-4e75-86f2-fa62af52b3bf","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"335d6dcc-829f-4e75-86f2-fa62af52b3bf"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"interpolate":{"value":"step-before"},"fill":{"value":"steelblue"},"fillOpacity":{"value":0.4},"stroke":{"value":"steelblue"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"335d6dcc-829f-4e75-86f2-fa62af52b3bf","values":[{"x":100.0,"y":0},{"x":104.45454545454545,"y":21.0},{"x":108.9090909090909,"y":3.0},{"x":113.36363636363636,"y":5.0},{"x":117.81818181818181,"y":8.0},{"x":122.27272727272727,"y":5.0},{"x":126.72727272727272,"y":7.0},{"x":131.1818181818182,"y":23.0},{"x":135.63636363636365,"y":24.0},{"x":140.09090909090912,"y":24.0},{"x":144.5454545454546,"y":46.0},{"x":149.00000000000006,"y":834.0},{"x":153.45454545454552,"y":0}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"335d6dcc-829f-4e75-86f2-fa62af52b3bf\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"335d6dcc-829f-4e75-86f2-fa62af52b3bf\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"335d6dcc-829f-4e75-86f2-fa62af52b3bf\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :interpolate {:value \"step-before\"}, :fill {:value \"steelblue\"}, :fillOpacity {:value 0.4}, :stroke {:value \"steelblue\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"335d6dcc-829f-4e75-86f2-fa62af52b3bf\", :values ({:x 100.0, :y 0} {:x 104.45454545454545, :y 21.0} {:x 108.9090909090909, :y 3.0} {:x 113.36363636363636, :y 5.0} {:x 117.81818181818181, :y 8.0} {:x 122.27272727272727, :y 5.0} {:x 126.72727272727272, :y 7.0} {:x 131.1818181818182, :y 23.0} {:x 135.63636363636365, :y 24.0} {:x 140.09090909090912, :y 24.0} {:x 144.5454545454546, :y 46.0} {:x 149.00000000000006, :y 834.0} {:x 153.45454545454552, :y 0})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
